...
def gene_selection(
    ...
    """
    Select source-derived highly variable genes for cross-platform transfer.
...
if __name__ == "__main__":
    ...
    experiments = {
        "STHBC2ViHBC": {
            "ref_names": sthbc_names,
            "save_dir": project_root / "processed_data" / "STHBC2ViHBC",
        },
        "ViHBC2STHBC": {
            "ref_names": vihbc_names,
            "save_dir": project_root / "processed_data" / "ViHBC2STHBC",
        },
    }
